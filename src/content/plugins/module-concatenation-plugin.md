...
这个插件会在 webpack 中实现以上的预编译功能。By default this plugin is already enabled in [production `mode`](/concepts/mode/#mode-production) and disabled otherwise. If you need it in other modes, you can add it manually:
